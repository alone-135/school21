rm -rf $HOME/goinfre/brew/.brew $HOME/goinfre/brew/.brewconfig.zsh $HOME/.brew $HOME/.brewconfig.zsh
git clone --depth=1 https://github.com/Homebrew/brew $HOME/goinfre/brew/.brew

# Create .brewconfig script in home directory 
cat > $HOME/goinfre/brew/.brewconfig.zsh <<EOL
# HOMEBREW CONFIG

# Add brew to path
export PATH=\$HOME/goinfre/brew/.brew/bin:\$PATH
...
then
  ...
  HOMEBREW_LOCKS_FOLDER=\$HOME/goinfre/brew/.brew/var/homebrew
...
source $HOME/goinfre/brew/.brewconfig.zsh
EOL
fi
