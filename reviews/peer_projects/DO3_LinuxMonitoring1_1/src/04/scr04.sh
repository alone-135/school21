...
function output {
    ...
    if [[ ${default_color} = 0 ]] ; then
        echo
        echo -e "Column 1 background = ${arg_1}${bg_color_name}"
        echo -e "Column 1 font color = ${arg_2}${txt_color_name}"
        echo -e "Column 2 background = ${arg_3}${bg_color1_name}"
        echo -e "Column 2 font color = ${arg_4}${txt_color1_name}"

    else
        echo
        echo -e "Column 1 background = default${bg_color_name}"
        echo -e "Column 1 font color = default${txt_color_name}"
        echo -e "Column 2 background = default${bg_color1_name}"
        echo -e "Column 2 font color = default${txt_color1_name}"
    fi
}
